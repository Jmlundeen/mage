...
public final class FinalFantasy extends ExpansionSet {
    ...
    private FinalFantasy() {
        ...
        cards.add(new SetCardInfo("Fang, Fearless l'Cie", "99", "99b", Rarity.UNCOMMON, mage.cards.f.FangFearlessLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fang, Fearless l'Cie", "381", "381b", Rarity.UNCOMMON, mage.cards.f.FangFearlessLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fang, Fearless l'Cie", "446", "446b", Rarity.UNCOMMON, mage.cards.f.FangFearlessLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fang, Fearless l'Cie", "526", "526b", Rarity.UNCOMMON, mage.cards.f.FangFearlessLCie.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Vanille, Cheerful l'Cie", "211", "99b", Rarity.UNCOMMON, mage.cards.v.VanilleCheerfulLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vanille, Cheerful l'Cie", "392", "381b", Rarity.UNCOMMON, mage.cards.v.VanilleCheerfulLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vanille, Cheerful l'Cie", "475", "446b", Rarity.UNCOMMON, mage.cards.v.VanilleCheerfulLCie.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Vanille, Cheerful l'Cie", "537", "526b", Rarity.UNCOMMON, mage.cards.v.VanilleCheerfulLCie.class, NON_FULL_USE_VARIOUS));
