...
public class SecretLairDrop extends ExpansionSet {
    ...
    private void addPart1() {
        ...
        cards.add(new SetCardInfo("Alela, Artful Provocateur", 1197, Rarity.MYTHIC, mage.cards.a.AlelaArtfulProvocateur.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Amareth, the Lustrous", 2254, Rarity.RARE, mage.cards.a.AmarethTheLustrous.class));
        ...
        cards.add(new SetCardInfo("Amy Rose", 2083, Rarity.MYTHIC, mage.cards.a.AmyRose.class));
        ...
        cards.add(new SetCardInfo("Anguished Unmaking", 138, Rarity.RARE, mage.cards.a.AnguishedUnmaking.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Anowon, the Ruin Thief", "1568*", Rarity.MYTHIC, mage.cards.a.AnowonTheRuinThief.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Approach of the Second Sun", 1035, Rarity.RARE, mage.cards.a.ApproachOfTheSecondSun.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arcane Signet", 7065, Rarity.RARE, mage.cards.a.ArcaneSignet.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Arcbound Ravager", 56, Rarity.RARE, mage.cards.a.ArcboundRavager.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Arcbound Ravager", 2105, Rarity.RARE, mage.cards.a.ArcboundRavager.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archaeomancer", 283, Rarity.RARE, mage.cards.a.Archaeomancer.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Archaeomancer", 2242, Rarity.RARE, mage.cards.a.Archaeomancer.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Assassin's Trophy", 139, Rarity.RARE, mage.cards.a.AssassinsTrophy.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Azusa, Lost but Seeking", "1597*", Rarity.RARE, mage.cards.a.AzusaLostButSeeking.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Back to Basics", 1718, Rarity.RARE, mage.cards.b.BackToBasics.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Beast Within", 323, Rarity.RARE, mage.cards.b.BeastWithin.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Blasphemous Act", 322, Rarity.RARE, mage.cards.b.BlasphemousAct.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Blind Obedience", 2246, Rarity.RARE, mage.cards.b.BlindObedience.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Brainstorm", 7013, Rarity.RARE, mage.cards.b.Brainstorm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brainstorm", 7016, Rarity.RARE, mage.cards.b.Brainstorm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brainstorm", 7019, Rarity.RARE, mage.cards.b.Brainstorm.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Brash Taunter", 1614, Rarity.RARE, mage.cards.b.BrashTaunter.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Bruna, Light of Alabaster", 1221, Rarity.MYTHIC, mage.cards.b.BrunaLightOfAlabaster.class, FULL_ART));
        cards.add(new SetCardInfo("Bruna, the Fading Light", "1336", "1388b", Rarity.RARE, mage.cards.b.BrunaTheFadingLight.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Burnt Offering", 7047, Rarity.RARE, mage.cards.b.BurntOffering.class));
        ...
        cards.add(new SetCardInfo("Cathartic Reunion", "1465*", Rarity.RARE, mage.cards.c.CatharticReunion.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Cathartic Reunion", 7045, Rarity.RARE, mage.cards.c.CatharticReunion.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Champion of Lambholt", 2245, Rarity.RARE, mage.cards.c.ChampionOfLambholt.class));
        ...
        cards.add(new SetCardInfo("Chromatic Lantern", 2329, Rarity.RARE, mage.cards.c.ChromaticLantern.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Command Tower", 7030, Rarity.RARE, mage.cards.c.CommandTower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Command Tower", 7063, Rarity.RARE, mage.cards.c.CommandTower.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Command Tower", 7064, Rarity.RARE, mage.cards.c.CommandTower.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Consecrated Sphinx", 7023, Rarity.MYTHIC, mage.cards.c.ConsecratedSphinx.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Council's Judgment", "1635*", Rarity.RARE, mage.cards.c.CouncilsJudgment.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Council's Judgment", 7041, Rarity.RARE, mage.cards.c.CouncilsJudgment.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Cultural Exchange", 2071, Rarity.RARE, mage.cards.c.CulturalExchange.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Darksteel Mutation", 1836, Rarity.UNCOMMON, mage.cards.d.DarksteelMutation.class));
        ...
        cards.add(new SetCardInfo("Deadly Dispute", 1980, Rarity.RARE, mage.cards.d.DeadlyDispute.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Deadly Dispute", 1985, Rarity.RARE, mage.cards.d.DeadlyDispute.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Deadly Dispute", 2091, Rarity.RARE, mage.cards.d.DeadlyDispute.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Decimate", 140, Rarity.RARE, mage.cards.d.Decimate.class, FULL_ART));
        cards.add(new SetCardInfo("Decree of Pain", 187, Rarity.RARE, mage.cards.d.DecreeOfPain.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Delayed Blast Fireball", 1824, Rarity.RARE, mage.cards.d.DelayedBlastFireball.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Dismember", 321, Rarity.RARE, mage.cards.d.Dismember.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Distant Melody", 2326, Rarity.RARE, mage.cards.d.DistantMelody.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Dr. Eggman", 2084, Rarity.MYTHIC, mage.cards.d.DrEggman.class));
        ...
        cards.add(new SetCardInfo("Drakuseth, Maw of Flames", 2237, Rarity.RARE, mage.cards.d.DrakusethMawOfFlames.class));
        ...
        cards.add(new SetCardInfo("Eldrazi Conscription", 1218, Rarity.RARE, mage.cards.e.EldraziConscription.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Endurance", 7008, Rarity.MYTHIC, mage.cards.e.Endurance.class));
        ...
        cards.add(new SetCardInfo("Estrid's Invocation", 1325, Rarity.RARE, mage.cards.e.EstridsInvocation.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Estrid's Invocation", "1325b", Rarity.RARE, mage.cards.e.EstridsInvocation.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Estrid, the Masked", 1327, Rarity.MYTHIC, mage.cards.e.EstridTheMasked.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Explore", 2327, Rarity.RARE, mage.cards.e.Explore.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fabricate", 2090, Rarity.RARE, mage.cards.f.Fabricate.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fatal Push", 7014, Rarity.RARE, mage.cards.f.FatalPush.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fatal Push", 7017, Rarity.RARE, mage.cards.f.FatalPush.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Fatal Push", 7020, Rarity.RARE, mage.cards.f.FatalPush.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fierce Guardianship", 1823, Rarity.RARE, mage.cards.f.FierceGuardianship.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Font of Mythos", 2075, Rarity.RARE, mage.cards.f.FontOfMythos.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Forest", 363, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 388, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 395, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 419, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Forest", 452, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 476, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Forest", 690, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 892, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1092, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1134, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1194, Rarity.LAND, mage.cards.basiclands.Forest.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1386, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1403, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1472, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1482, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1515, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Forest", 1943, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1949, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Forest", 1954, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Forest", 2080, Rarity.LAND, mage.cards.basiclands.Forest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fury", 7007, Rarity.MYTHIC, mage.cards.f.Fury.class));
        ...
        cards.add(new SetCardInfo("Generous Gift", 2088, Rarity.RARE, mage.cards.g.GenerousGift.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ghostly Prison", 424, Rarity.RARE, mage.cards.g.GhostlyPrison.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghostly Prison", 1837, Rarity.UNCOMMON, mage.cards.g.GhostlyPrison.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghostly Prison", 7042, Rarity.RARE, mage.cards.g.GhostlyPrison.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Ghoulish Impetus", 1843, Rarity.RARE, mage.cards.g.GhoulishImpetus.class));
        ...
        cards.add(new SetCardInfo("Gisela, the Broken Blade", "1335", "1388b", Rarity.MYTHIC, mage.cards.g.GiselaTheBrokenBlade.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Goblin Bombardment", 7022, Rarity.RARE, mage.cards.g.GoblinBombardment.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Goblin Bushwhacker", 17, Rarity.RARE, mage.cards.g.GoblinBushwhacker.class));
        cards.add(new SetCardInfo("Goblin Chieftain", 1615, Rarity.RARE, mage.cards.g.GoblinChieftain.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Goblin Recruiter", "1313*", Rarity.RARE, mage.cards.g.GoblinRecruiter.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Goblin Ringleader", 1616, Rarity.RARE, mage.cards.g.GoblinRingleader.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Goblin Welder", 1617, Rarity.RARE, mage.cards.g.GoblinWelder.class, FULL_ART));
        cards.add(new SetCardInfo("Godless Shrine", 128, Rarity.RARE, mage.cards.g.GodlessShrine.class));
        cards.add(new SetCardInfo("Godo, Bandit Warlord", 1200, Rarity.RARE, mage.cards.g.GodoBanditWarlord.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Grand Abolisher", 1285, Rarity.RARE, mage.cards.g.GrandAbolisher.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Grand Abolisher", 2241, Rarity.RARE, mage.cards.g.GrandAbolisher.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Grief", 7006, Rarity.MYTHIC, mage.cards.g.Grief.class));
        cards.add(new SetCardInfo("Grim Backwoods", 354, Rarity.RARE, mage.cards.g.GrimBackwoods.class));
        cards.add(new SetCardInfo("Grim Haruspex", 2243, Rarity.RARE, mage.cards.g.GrimHaruspex.class));
        ...
        cards.add(new SetCardInfo("Hammer of Nazahn", 2098, Rarity.RARE, mage.cards.h.HammerOfNazahn.class));
        ...
        cards.add(new SetCardInfo("Harmonize", "1596*", Rarity.RARE, mage.cards.h.Harmonize.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Harmonize", 7015, Rarity.RARE, mage.cards.h.Harmonize.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Harmonize", 7018, Rarity.RARE, mage.cards.h.Harmonize.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Harmonize", 7021, Rarity.RARE, mage.cards.h.Harmonize.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Helix Pinnacle", 1831, Rarity.RARE, mage.cards.h.HelixPinnacle.class));
        ...
        cards.add(new SetCardInfo("Howling Mine", 177, Rarity.RARE, mage.cards.h.HowlingMine.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Howling Mine", 7046, Rarity.RARE, mage.cards.h.HowlingMine.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Hullbreaker Horror", 2321, Rarity.RARE, mage.cards.h.HullbreakerHorror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Hullbreaker Horror", 2336, Rarity.RARE, mage.cards.h.HullbreakerHorror.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Imperial Recruiter", 2244, Rarity.MYTHIC, mage.cards.i.ImperialRecruiter.class));
        ...
        cards.add(new SetCardInfo("Inspiring Call", 2313, Rarity.RARE, mage.cards.i.InspiringCall.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Inspiring Call", 2328, Rarity.RARE, mage.cards.i.InspiringCall.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 64, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 240, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 255, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 360, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 385, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 386, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 392, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 416, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Island", 449, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 466, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 673, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 889, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Island", 1089, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1131, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1191, Rarity.LAND, mage.cards.basiclands.Island.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1383, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1400, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1469, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1479, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Island", 1940, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 1946, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Island", 1951, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2077, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2144, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2145, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2146, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Island", 2147, Rarity.LAND, mage.cards.basiclands.Island.class, NON_FULL_USE_VARIOUS));
    ...
    private void addPart2() {
        cards.add(new SetCardInfo("Kalamax, the Stormsire", 2252, Rarity.MYTHIC, mage.cards.k.KalamaxTheStormsire.class));
        ...
        cards.add(new SetCardInfo("Knuckles the Echidna", 2082, Rarity.MYTHIC, mage.cards.k.KnucklesTheEchidna.class));
        ...
        cards.add(new SetCardInfo("Lightning Bolt", 1822, Rarity.RARE, mage.cards.l.LightningBolt.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lightning Greaves", 2099, Rarity.RARE, mage.cards.l.LightningGreaves.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lord of the Pit", 893, Rarity.RARE, mage.cards.l.LordOfThePit.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Lotus Petal", 7031, Rarity.MYTHIC, mage.cards.l.LotusPetal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lotus Petal", 7032, Rarity.MYTHIC, mage.cards.l.LotusPetal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lotus Petal", 7033, Rarity.MYTHIC, mage.cards.l.LotusPetal.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Lotus Petal", 7034, Rarity.MYTHIC, mage.cards.l.LotusPetal.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Maddening Cacophony", 2322, Rarity.RARE, mage.cards.m.MaddeningCacophony.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Maddening Cacophony", 2337, Rarity.RARE, mage.cards.m.MaddeningCacophony.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mana Geyser", 1821, Rarity.RARE, mage.cards.m.ManaGeyser.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Maze's End", 1834, Rarity.MYTHIC, mage.cards.m.MazesEnd.class));
        ...
        cards.add(new SetCardInfo("Mechanized Production", 1841, Rarity.MYTHIC, mage.cards.m.MechanizedProduction.class));
        ...
        cards.add(new SetCardInfo("Miles \"Tails\" Prower", 2085, Rarity.MYTHIC, mage.cards.m.MilesTailsPrower.class));
        ...
        cards.add(new SetCardInfo("Minds Aglow", 7028, Rarity.RARE, mage.cards.m.MindsAglow.class, FULL_ART));
        cards.add(new SetCardInfo("Minsc & Boo, Timeless Heroes", 879, Rarity.MYTHIC, mage.cards.m.MinscBooTimelessHeroes.class));
        cards.add(new SetCardInfo("Mirage Mirror", 2030, Rarity.RARE, mage.cards.m.MirageMirror.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mirage Mirror", 7025, Rarity.RARE, mage.cards.m.MirageMirror.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Miscast", 2317, Rarity.RARE, mage.cards.m.Miscast.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Miscast", 2332, Rarity.RARE, mage.cards.m.Miscast.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mizzium Mortars", 2249, Rarity.RARE, mage.cards.m.MizziumMortars.class));
        cards.add(new SetCardInfo("Mogg War Marshal", 1618, Rarity.RARE, mage.cards.m.MoggWarMarshal.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Monologue Tax", 1838, Rarity.RARE, mage.cards.m.MonologueTax.class));
        ...
        cards.add(new SetCardInfo("Mountain", 362, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 387, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 389, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 418, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 451, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 674, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 891, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1091, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1133, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 1385, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1402, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1471, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1481, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1514, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 1942, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1948, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 1953, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mountain", 2079, Rarity.LAND, mage.cards.basiclands.Mountain.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mycosynth Wellspring", "1435*", Rarity.RARE, mage.cards.m.MycosynthWellspring.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Myr Battlesphere", 2097, Rarity.RARE, mage.cards.m.MyrBattlesphere.class));
        cards.add(new SetCardInfo("Mystic Remora", 406, Rarity.RARE, mage.cards.m.MysticRemora.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Mystic Remora", 1842, Rarity.RARE, mage.cards.m.MysticRemora.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Nezahal, Primal Tide", 2236, Rarity.RARE, mage.cards.n.NezahalPrimalTide.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Open the Armory", 2089, Rarity.RARE, mage.cards.o.OpenTheArmory.class));
        ...
        cards.add(new SetCardInfo("Pariah", 1839, Rarity.RARE, mage.cards.p.Pariah.class));
        ...
        cards.add(new SetCardInfo("Phage the Untouchable", 1195, Rarity.MYTHIC, mage.cards.p.PhageTheUntouchable.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Phyrexian Arena", 2318, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Phyrexian Arena", 2333, Rarity.RARE, mage.cards.p.PhyrexianArena.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 46, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 63, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 239, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 254, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 359, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 390, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 391, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 448, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 670, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 888, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1088, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1130, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 1382, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1399, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1468, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1478, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1513, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Plains", 1939, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1945, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Plains", 1950, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Plains", 2076, Rarity.LAND, mage.cards.basiclands.Plains.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Preordain", 186, Rarity.RARE, mage.cards.p.Preordain.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Preordain", 1719, Rarity.RARE, mage.cards.p.Preordain.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Razaketh, the Foulblooded", "163*", Rarity.MYTHIC, mage.cards.r.RazakethTheFoulblooded.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Razaketh, the Foulblooded", 2251, Rarity.MYTHIC, mage.cards.r.RazakethTheFoulblooded.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Read the Bones", 7066, Rarity.RARE, mage.cards.r.ReadTheBones.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Resculpt", 2029, Rarity.RARE, mage.cards.r.Resculpt.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Resculpt", 7024, Rarity.RARE, mage.cards.r.Resculpt.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Revel in Riches", 1830, Rarity.RARE, mage.cards.r.RevelInRiches.class));
        ...
        cards.add(new SetCardInfo("Sarulf, Realm Eater", 2240, Rarity.RARE, mage.cards.s.SarulfRealmEater.class));
        ...
        cards.add(new SetCardInfo("Scion of Draco", 2031, Rarity.MYTHIC, mage.cards.s.ScionOfDraco.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Scion of Draco", 7026, Rarity.MYTHIC, mage.cards.s.ScionOfDraco.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Scute Swarm", 7048, Rarity.RARE, mage.cards.s.ScuteSwarm.class));
        ...
        cards.add(new SetCardInfo("Seize the Spotlight", 7044, Rarity.RARE, mage.cards.s.SeizeTheSpotlight.class));
        ...
        cards.add(new SetCardInfo("Sen Triplets", 1198, Rarity.MYTHIC, mage.cards.s.SenTriplets.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Seven Dwarves", 819, Rarity.RARE, mage.cards.s.SevenDwarves.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Shadow the Hedgehog", 2086, Rarity.MYTHIC, mage.cards.s.ShadowTheHedgehog.class));
        ...
        cards.add(new SetCardInfo("Silence", 881, Rarity.RARE, mage.cards.s.Silence.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Simian Spirit Guide", "1548*", Rarity.RARE, mage.cards.s.SimianSpiritGuide.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Simic Ascendancy", 1832, Rarity.RARE, mage.cards.s.SimicAscendancy.class));
        ...
        cards.add(new SetCardInfo("Snap", 2247, Rarity.RARE, mage.cards.s.Snap.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Snow-Covered Forest", 329, Rarity.LAND, mage.cards.s.SnowCoveredForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Forest", 1477, Rarity.LAND, mage.cards.s.SnowCoveredForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Forest", "1477*", Rarity.LAND, mage.cards.s.SnowCoveredForest.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 2, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 326, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", 1474, Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Island", "1474*", Rarity.LAND, mage.cards.s.SnowCoveredIsland.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Snow-Covered Mountain", 328, Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", 1476, Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Mountain", "1476*", Rarity.LAND, mage.cards.s.SnowCoveredMountain.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 1, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 325, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", 1473, Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Plains", "1473*", Rarity.LAND, mage.cards.s.SnowCoveredPlains.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 3, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 327, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", 1475, Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Snow-Covered Swamp", "1475*", Rarity.LAND, mage.cards.s.SnowCoveredSwamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sol Ring", 912, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sol Ring", 913, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sol Ring", 1833, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sol Ring", 2093, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sol Ring", 2315, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sol Ring", 2330, Rarity.RARE, mage.cards.s.SolRing.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Solitude", 7004, Rarity.MYTHIC, mage.cards.s.Solitude.class));
        cards.add(new SetCardInfo("Solve the Equation", 886, Rarity.RARE, mage.cards.s.SolveTheEquation.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Sonic the Hedgehog", 2087, Rarity.MYTHIC, mage.cards.s.SonicTheHedgehog.class));
        ...
        cards.add(new SetCardInfo("Sphere of Safety", 2331, Rarity.RARE, mage.cards.s.SphereOfSafety.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Sphinx of the Second Sun", 1720, Rarity.MYTHIC, mage.cards.s.SphinxOfTheSecondSun.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Steely Resolve", 1326, Rarity.RARE, mage.cards.s.SteelyResolve.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Steely Resolve", "1326b", Rarity.RARE, mage.cards.s.SteelyResolve.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Stitcher's Supplier", 1098, Rarity.RARE, mage.cards.s.StitchersSupplier.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Subtlety", 7005, Rarity.MYTHIC, mage.cards.s.Subtlety.class));
        ...
        cards.add(new SetCardInfo("Super State", 2081, Rarity.MYTHIC, mage.cards.s.SuperState.class));
        ...
        cards.add(new SetCardInfo("Swamp", 65, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 119, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 361, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 384, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 394, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 417, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 450, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 486, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 539, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 1090, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1132, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1192, Rarity.LAND, mage.cards.basiclands.Swamp.class, RETRO_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1384, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1401, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1470, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1480, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swamp", 1941, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1947, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_BFZ_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 1952, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Swamp", 2078, Rarity.LAND, mage.cards.basiclands.Swamp.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Swiftfoot Boots", 2096, Rarity.RARE, mage.cards.s.SwiftfootBoots.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tamiyo's Safekeeping", 2320, Rarity.RARE, mage.cards.t.TamiyosSafekeeping.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tamiyo's Safekeeping", 2335, Rarity.RARE, mage.cards.t.TamiyosSafekeeping.class, NON_FULL_USE_VARIOUS));
    ...
    private void addPart3() {
        ...
        cards.add(new SetCardInfo("Test of Endurance", 1840, Rarity.MYTHIC, mage.cards.t.TestOfEndurance.class));
        ...
        cards.add(new SetCardInfo("The Reaver Cleaver", 2095, Rarity.RARE, mage.cards.t.TheReaverCleaver.class));
        ...
        cards.add(new SetCardInfo("Thraximundar", 142, Rarity.MYTHIC, mage.cards.t.Thraximundar.class, FULL_ART));
        ...
        cards.add(new SetCardInfo("Thrun, the Last Troll", 810, Rarity.MYTHIC, mage.cards.t.ThrunTheLastTroll.class, FULL_ART));
        cards.add(new SetCardInfo("Tiamat", 1017, Rarity.MYTHIC, mage.cards.t.Tiamat.class));
        cards.add(new SetCardInfo("Tibalt's Trickery", 7027, Rarity.RARE, mage.cards.t.TibaltsTrickery.class));
        ...
        cards.add(new SetCardInfo("Tooth and Nail", 2250, Rarity.RARE, mage.cards.t.ToothAndNail.class));
        ...
        cards.add(new SetCardInfo("Tormenting Voice", 2319, Rarity.RARE, mage.cards.t.TormentingVoice.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Tormenting Voice", 2334, Rarity.RARE, mage.cards.t.TormentingVoice.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Tragic Slip", 7043, Rarity.RARE, mage.cards.t.TragicSlip.class));
        ...
        cards.add(new SetCardInfo("Trinisphere", "1485*", Rarity.MYTHIC, mage.cards.t.Trinisphere.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Triskaidekaphile", 1829, Rarity.RARE, mage.cards.t.Triskaidekaphile.class));
        ...
        cards.add(new SetCardInfo("Umbris, Fear Manifest", 2324, Rarity.MYTHIC, mage.cards.u.UmbrisFearManifest.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Unbreakable Formation", 310, Rarity.RARE, mage.cards.u.UnbreakableFormation.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Undead Alchemist", 836, Rarity.RARE, mage.cards.u.UndeadAlchemist.class, RETRO_ART));
        ...
        cards.add(new SetCardInfo("Unexpected Windfall", 2092, Rarity.RARE, mage.cards.u.UnexpectedWindfall.class));
        ...
        cards.add(new SetCardInfo("Unleash Fury", 7050, Rarity.RARE, mage.cards.u.UnleashFury.class));
        ...
        cards.add(new SetCardInfo("Vaevictis Asmadi, the Dire", 2239, Rarity.MYTHIC, mage.cards.v.VaevictisAsmadiTheDire.class));
        ...
        cards.add(new SetCardInfo("Vilis, Broker of Blood", "1567*", Rarity.RARE, mage.cards.v.VilisBrokerOfBlood.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Village Rites", 2248, Rarity.RARE, mage.cards.v.VillageRites.class));
        ...
        cards.add(new SetCardInfo("Wasitora, Nekoru Queen", 2253, Rarity.RARE, mage.cards.w.WasitoraNekoruQueen.class));
        ...
        cards.add(new SetCardInfo("Wastes", 704, Rarity.LAND, mage.cards.w.Wastes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", 705, Rarity.LAND, mage.cards.w.Wastes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", 706, Rarity.LAND, mage.cards.w.Wastes.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Wastes", "795*", Rarity.LAND, mage.cards.w.Wastes.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Wayward Swordtooth", "1392*", Rarity.RARE, mage.cards.w.WaywardSwordtooth.class, FULL_ART_USE_VARIOUS));
        cards.add(new SetCardInfo("Weatherlight", 2100, Rarity.MYTHIC, mage.cards.w.Weatherlight.class));
        ...
        cards.add(new SetCardInfo("Wild Growth", 7049, Rarity.RARE, mage.cards.w.WildGrowth.class));
        ...
        cards.add(new SetCardInfo("Wrath of God", 185, Rarity.RARE, mage.cards.w.WrathOfGod.class, FULL_ART_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Ziatora, the Incinerator", 2238, Rarity.MYTHIC, mage.cards.z.ZiatoraTheIncinerator.class));
