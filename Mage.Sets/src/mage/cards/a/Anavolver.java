...
public final class Anavolver extends CardImpl {
    ...
    public Anavolver(UUID ownerId, CardSetInfo setInfo) {
        ...
        EntersBattlefieldAbility ability1 = new EntersBattlefieldAbility(
                ...
                new KickedCostCondition("{1}{U}"),
                "If {this} was kicked with its {1}{U} kicker, it enters with two +1/+1 counters on it and with flying.",
                "{this} enters with two +1/+1 counters on it and with flying");
        ability1.addEffect(new ContinuousEffectBuilder(Duration.WhileOnBattlefield, Outcome.AddAbility, ContinuousAffected.SOURCE)
        ...
        ability2.addEffect(new ContinuousEffectBuilder(Duration.WhileOnBattlefield, Outcome.AddAbility, ContinuousAffected.SOURCE)
