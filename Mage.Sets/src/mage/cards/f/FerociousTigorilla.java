...
public final class FerociousTigorilla extends CardImpl {
    ...
    public FerociousTigorilla(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(new SimpleStaticAbility(
                new EntersWithCountersEffect(CounterType.TRAMPLE.createInstance())
                        .withAdditionalCounters(CounterType.MENACE)
                        .withChooseCounter()
                        .setText("with your choice of a trample counter or a menace counter on it. " +
