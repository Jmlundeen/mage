...
public final class Degavolver extends CardImpl {
    ...
    public Degavolver(UUID ownerId, CardSetInfo setInfo) {
        ...
        Effect gainAbilityEffect = new ContinuousEffectBuilder(Outcome.AddAbility, ContinuousAffected.SOURCE)
        ...
        ((EntersBattlefieldEffect)ability1.getEffects().get(0)).addEffect(gainAbilityEffect);
        this.addAbility(ability1);

        // If Degavolver was kicked with its {R} kicker, it enters with a +1/+1 counter on it and with first strike.
        Effect gainFirstStrikeEffect = new ContinuousEffectBuilder(Outcome.AddAbility, ContinuousAffected.SOURCE)
        ...
        ((EntersBattlefieldEffect)ability2.getEffects().get(0)).addEffect(gainFirstStrikeEffect);
