...
public final class MechHangar extends CardImpl {
    ...
    private static final FilterTyped filter = new FilterTyped("a Pilot or Vehicle spell")
            .addAll(
    ...
    public MechHangar(UUID ownerId, CardSetInfo setInfo) {
        ...
        this.addAbility(ComposedManaAbilityBuilder.builder()
                ...
                .ruleText("Add one mana of any color. Spend this mana only to cast a Pilot or Vehicle spell.")
                .build()
        );
