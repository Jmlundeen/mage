...
public class MatchView implements Serializable {
    ...
    public ViewProto.MatchView toProto() {
        ViewProto.MatchView.Builder builder = ViewProto.MatchView.newBuilder()
                .setTableId(tableId != null ? tableId.toString() : "")
                .setMatchId(matchId != null ? matchId.toString() : "")
                .setMatchName(matchName != null ? matchName : "")
                ...
                .setReplayAvailable(replayAvailable)
    ...
    public static MatchView fromProto(ViewProto.MatchView proto) {
        return new MatchView(proto);
    }

    // Private constructor for fromProto
    private MatchView(ViewProto.MatchView proto) {
        ...
        this.matchName = proto.getMatchName();
        ...
        this.replayAvailable = proto.getReplayAvailable();
