        ...
        switch (fromZone) {
            ...
            case STACK:
                ...
                if (stackObject == null && (this instanceof SplitCard)) {
                    stackObject = game.getStack().getSpell(((SplitCard) this).getLeftHalfCard().getId(), isCopy());
                    if (stackObject == null) {
                ...
                if (stackObject == null && (this instanceof ModalDoubleFacedCard)) {
                    ...
                    if (stackObject == null) {
                        stackObject = game.getStack()
                                .getSpell(((ModalDoubleFacedCard) this).getRightHalfCard().getId(), isCopy());
                    }
                }

                if (stackObject == null && (this instanceof CardWithSpellOption)) {
                    stackObject = game.getStack().getSpell(((CardWithSpellOption) this).getSpellCard().getId(), isCopy());
                }
