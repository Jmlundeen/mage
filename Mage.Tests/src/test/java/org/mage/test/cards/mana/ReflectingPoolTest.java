...
public class ReflectingPoolTest extends CardTestPlayerBase {
    ...
    public void testWithExoticOrchard() {
        ...
        Assert.assertEquals("Player should be able to create 2 red mana", "{R}{R}", options.toManaList().getFirst().toString());
    ...
    public void test2WithExoticOrchard() {
        ...
        ManaOptions options = playerA.getAvailableManaTest(currentGame);
        Assert.assertEquals("Player should be able to create 3 red mana", "{R}{R}{R}", options.toManaList().getFirst().toString());
    ...
    public void testWithGaeasCradle() {
        ...
        ManaOptions options = playerA.getAvailableManaTest(currentGame);
        Assert.assertEquals("Player should be able to create 2 green mana", "{G}{G}", options.toManaList().getFirst().toString());
